...
export interface RuleOptions {
   ...
   * @see https://github.com/antfu/eslint-plugin-antfu/blob/main/src/rules/consistent-chaining.md
   */
  'fino/consistent-chaining'?: Linter.RuleEntry<FinoConsistentChaining>
  /**
   * Having line breaks styles to object, array and named imports
   * @see https://github.com/antfu/eslint-plugin-antfu/blob/main/src/rules/consistent-list-newline.md
   */
  'fino/consistent-list-newline'?: Linter.RuleEntry<FinoConsistentListNewline>
  /**
   * Enforce Anthony's style of curly bracket
   * @see https://github.com/antfu/eslint-plugin-antfu/blob/main/src/rules/curly.md
   */
  'fino/curly'?: Linter.RuleEntry<[]>
  /**
   * Newline after if
   * @see https://github.com/antfu/eslint-plugin-antfu/blob/main/src/rules/if-newline.md
   */
  'fino/if-newline'?: Linter.RuleEntry<[]>
  /**
   * Fix duplication in imports
   * @see https://github.com/antfu/eslint-plugin-antfu/blob/main/src/rules/import-dedupe.md
   */
  'fino/import-dedupe'?: Linter.RuleEntry<[]>
  /**
   * Enforce consistent indentation in `unindent` template tag
   * @see https://github.com/antfu/eslint-plugin-antfu/blob/main/src/rules/indent-unindent.md
   */
  'fino/indent-unindent'?: Linter.RuleEntry<FinoIndentUnindent>
  /**
   * Prevent importing modules in `dist` folder
   * @see https://github.com/antfu/eslint-plugin-antfu/blob/main/src/rules/no-import-dist.test.ts
   */
  'fino/no-import-dist'?: Linter.RuleEntry<[]>
  /**
   * Prevent importing modules in `node_modules` folder by relative or absolute path
   * @see https://github.com/antfu/eslint-plugin-antfu/blob/main/src/rules/no-import-node-modules-by-path.test.ts
   */
  'fino/no-import-node-modules-by-path'?: Linter.RuleEntry<[]>
  /**
   * Prevent using top-level await
   * @see https://github.com/antfu/eslint-plugin-antfu/blob/main/src/rules/no-top-level-await.test.ts
   */
  'fino/no-top-level-await'?: Linter.RuleEntry<[]>
  /**
   * Do not use `exports =`
   * @see https://github.com/antfu/eslint-plugin-antfu/blob/main/src/rules/no-ts-export-equal.test.ts
   */
  'fino/no-ts-export-equal'?: Linter.RuleEntry<[]>
  /**
   * Enforce top-level functions to be declared with function keyword
   * @see https://github.com/antfu/eslint-plugin-antfu/blob/main/src/rules/top-level-function.md
   */
  'fino/top-level-function'?: Linter.RuleEntry<[]>
  /**
  ...
  /**
   * @see https://github.com/wix/eslint-plugin-lodash/blob/v8.0.0/docs/rules/callback-binding.md
   */
  'lodash/callback-binding'?: Linter.RuleEntry<[]>
  /**
   * @see https://github.com/wix/eslint-plugin-lodash/blob/v8.0.0/docs/rules/chain-style.md
   */
  'lodash/chain-style'?: Linter.RuleEntry<LodashChainStyle>
  /**
   * @see https://github.com/wix/eslint-plugin-lodash/blob/v8.0.0/docs/rules/chaining.md
   */
  'lodash/chaining'?: Linter.RuleEntry<LodashChaining>
  /**
   * @see https://github.com/wix/eslint-plugin-lodash/blob/v8.0.0/docs/rules/collection-method-value.md
   */
  'lodash/collection-method-value'?: Linter.RuleEntry<[]>
  /**
   * @see https://github.com/wix/eslint-plugin-lodash/blob/v8.0.0/docs/rules/collection-ordering.md
   */
  'lodash/collection-ordering'?: Linter.RuleEntry<LodashCollectionOrdering>
  /**
   * @see https://github.com/wix/eslint-plugin-lodash/blob/v8.0.0/docs/rules/collection-return.md
   */
  'lodash/collection-return'?: Linter.RuleEntry<[]>
  /**
   * @see https://github.com/wix/eslint-plugin-lodash/blob/v8.0.0/docs/rules/consistent-compose.md
   */
  'lodash/consistent-compose'?: Linter.RuleEntry<LodashConsistentCompose>
  /**
   * @see https://github.com/wix/eslint-plugin-lodash/blob/v8.0.0/docs/rules/identity-shorthand.md
   */
  'lodash/identity-shorthand'?: Linter.RuleEntry<LodashIdentityShorthand>
  /**
   * @see https://github.com/wix/eslint-plugin-lodash/blob/v8.0.0/docs/rules/import-scope.md
   */
  'lodash/import-scope'?: Linter.RuleEntry<LodashImportScope>
  /**
   * @see https://github.com/wix/eslint-plugin-lodash/blob/v8.0.0/docs/rules/matches-prop-shorthand.md
   */
  'lodash/matches-prop-shorthand'?: Linter.RuleEntry<LodashMatchesPropShorthand>
  /**
   * @see https://github.com/wix/eslint-plugin-lodash/blob/v8.0.0/docs/rules/matches-shorthand.md
   */
  'lodash/matches-shorthand'?: Linter.RuleEntry<LodashMatchesShorthand>
  /**
   * @see https://github.com/wix/eslint-plugin-lodash/blob/v8.0.0/docs/rules/no-commit.md
   */
  'lodash/no-commit'?: Linter.RuleEntry<[]>
  /**
   * @see https://github.com/wix/eslint-plugin-lodash/blob/v8.0.0/docs/rules/no-double-unwrap.md
   */
  'lodash/no-double-unwrap'?: Linter.RuleEntry<[]>
  /**
   * @see https://github.com/wix/eslint-plugin-lodash/blob/v8.0.0/docs/rules/no-extra-args.md
   */
  'lodash/no-extra-args'?: Linter.RuleEntry<[]>
  /**
   * @see https://github.com/wix/eslint-plugin-lodash/blob/v8.0.0/docs/rules/no-unbound-this.md
   */
  'lodash/no-unbound-this'?: Linter.RuleEntry<[]>
  /**
   * @see https://github.com/wix/eslint-plugin-lodash/blob/v8.0.0/docs/rules/path-style.md
   */
  'lodash/path-style'?: Linter.RuleEntry<LodashPathStyle>
  /**
   * @see https://github.com/wix/eslint-plugin-lodash/blob/v8.0.0/docs/rules/prefer-compact.md
   */
  'lodash/prefer-compact'?: Linter.RuleEntry<[]>
  /**
   * @see https://github.com/wix/eslint-plugin-lodash/blob/v8.0.0/docs/rules/prefer-constant.md
   */
  'lodash/prefer-constant'?: Linter.RuleEntry<LodashPreferConstant>
  /**
   * @see https://github.com/wix/eslint-plugin-lodash/blob/v8.0.0/docs/rules/prefer-filter.md
   */
  'lodash/prefer-filter'?: Linter.RuleEntry<LodashPreferFilter>
  /**
   * @see https://github.com/wix/eslint-plugin-lodash/blob/v8.0.0/docs/rules/prefer-find.md
   */
  'lodash/prefer-find'?: Linter.RuleEntry<[]>
  /**
   * @see https://github.com/wix/eslint-plugin-lodash/blob/v8.0.0/docs/rules/prefer-flat-map.md
   */
  'lodash/prefer-flat-map'?: Linter.RuleEntry<[]>
  /**
   * @see https://github.com/wix/eslint-plugin-lodash/blob/v8.0.0/docs/rules/prefer-get.md
   */
  'lodash/prefer-get'?: Linter.RuleEntry<LodashPreferGet>
  /**
   * @see https://github.com/wix/eslint-plugin-lodash/blob/v8.0.0/docs/rules/prefer-immutable-method.md
   */
  'lodash/prefer-immutable-method'?: Linter.RuleEntry<[]>
  /**
   * @see https://github.com/wix/eslint-plugin-lodash/blob/v8.0.0/docs/rules/prefer-includes.md
   */
  'lodash/prefer-includes'?: Linter.RuleEntry<LodashPreferIncludes>
  /**
   * @see https://github.com/wix/eslint-plugin-lodash/blob/v8.0.0/docs/rules/prefer-invoke-map.md
   */
  'lodash/prefer-invoke-map'?: Linter.RuleEntry<[]>
  /**
   * @see https://github.com/wix/eslint-plugin-lodash/blob/v8.0.0/docs/rules/prefer-is-nil.md
   */
  'lodash/prefer-is-nil'?: Linter.RuleEntry<[]>
  /**
   * @see https://github.com/wix/eslint-plugin-lodash/blob/v8.0.0/docs/rules/prefer-lodash-chain.md
   */
  'lodash/prefer-lodash-chain'?: Linter.RuleEntry<[]>
  /**
   * @see https://github.com/wix/eslint-plugin-lodash/blob/v8.0.0/docs/rules/prefer-lodash-method.md
   */
  'lodash/prefer-lodash-method'?: Linter.RuleEntry<LodashPreferLodashMethod>
  /**
   * @see https://github.com/wix/eslint-plugin-lodash/blob/v8.0.0/docs/rules/prefer-lodash-typecheck.md
   */
  'lodash/prefer-lodash-typecheck'?: Linter.RuleEntry<[]>
  /**
   * @see https://github.com/wix/eslint-plugin-lodash/blob/v8.0.0/docs/rules/prefer-map.md
   */
  'lodash/prefer-map'?: Linter.RuleEntry<[]>
  /**
   * @see https://github.com/wix/eslint-plugin-lodash/blob/v8.0.0/docs/rules/prefer-matches.md
   */
  'lodash/prefer-matches'?: Linter.RuleEntry<LodashPreferMatches>
  /**
   * @see https://github.com/wix/eslint-plugin-lodash/blob/v8.0.0/docs/rules/prefer-noop.md
   */
  'lodash/prefer-noop'?: Linter.RuleEntry<[]>
  /**
   * @see https://github.com/wix/eslint-plugin-lodash/blob/v8.0.0/docs/rules/prefer-over-quantifier.md
   */
  'lodash/prefer-over-quantifier'?: Linter.RuleEntry<[]>
  /**
   * @see https://github.com/wix/eslint-plugin-lodash/blob/v8.0.0/docs/rules/prefer-reject.md
   */
  'lodash/prefer-reject'?: Linter.RuleEntry<LodashPreferReject>
  /**
   * @see https://github.com/wix/eslint-plugin-lodash/blob/v8.0.0/docs/rules/prefer-some.md
   */
  'lodash/prefer-some'?: Linter.RuleEntry<LodashPreferSome>
  /**
   * @see https://github.com/wix/eslint-plugin-lodash/blob/v8.0.0/docs/rules/prefer-startswith.md
   */
  'lodash/prefer-startswith'?: Linter.RuleEntry<[]>
  /**
   * @see https://github.com/wix/eslint-plugin-lodash/blob/v8.0.0/docs/rules/prefer-thru.md
   */
  'lodash/prefer-thru'?: Linter.RuleEntry<[]>
  /**
   * @see https://github.com/wix/eslint-plugin-lodash/blob/v8.0.0/docs/rules/prefer-times.md
   */
  'lodash/prefer-times'?: Linter.RuleEntry<[]>
  /**
   * @see https://github.com/wix/eslint-plugin-lodash/blob/v8.0.0/docs/rules/prefer-wrapper-method.md
   */
  'lodash/prefer-wrapper-method'?: Linter.RuleEntry<[]>
  /**
   * @see https://github.com/wix/eslint-plugin-lodash/blob/v8.0.0/docs/rules/preferred-alias.md
   */
  'lodash/preferred-alias'?: Linter.RuleEntry<LodashPreferredAlias>
  /**
   * @see https://github.com/wix/eslint-plugin-lodash/blob/v8.0.0/docs/rules/prop-shorthand.md
   */
  'lodash/prop-shorthand'?: Linter.RuleEntry<LodashPropShorthand>
  /**
   * @see https://github.com/wix/eslint-plugin-lodash/blob/v8.0.0/docs/rules/unwrap.md
   */
  'lodash/unwrap'?: Linter.RuleEntry<[]>
  /**
   ...
   * @see migrate
   */
  'style-migrate/migrate'?: Linter.RuleEntry<StyleMigrateMigrate>
  /**
   * Migrate built-in stylistic rules to @stylistic/js rules
   * @see migrate-js
   */
  'style-migrate/migrate-js'?: Linter.RuleEntry<StyleMigrateMigrateJs>
  /**
   * Migrate JSX stylistic rules from `eslint-plugin-react` to @stylistic/jsx rules
   * @see migrate-jsx
   */
  'style-migrate/migrate-jsx'?: Linter.RuleEntry<StyleMigrateMigrateJsx>
  /**
   * Migrate `@typescript-eslint` stylistic rules to `@stylistic/ts` rules
   * @see migrate-ts
   */
  'style-migrate/migrate-ts'?: Linter.RuleEntry<StyleMigrateMigrateTs>
  /**
   * Enforce linebreaks after opening and before closing array brackets
...
type FinoConsistentChaining = []|[{
  
  allowLeadingPropertyAccess?: boolean
}]
// ----- fino/consistent-list-newline -----
type FinoConsistentListNewline = []|[{
  ArrayExpression?: boolean
  ArrayPattern?: boolean
  ArrowFunctionExpression?: boolean
  CallExpression?: boolean
...
// ----- fino/indent-unindent -----
type FinoIndentUnindent = []|[{
  indent?: number
  tags?: string[]
}]
// ----- format/dprint -----
...
// ----- lodash/chain-style -----
type LodashChainStyle = []|[("as-needed" | "implicit" | "explicit")]
// ----- lodash/chaining -----
type LodashChaining = []|[("always" | "never" | "implicit")]|[("always" | "never" | "implicit"), number]
// ----- lodash/collection-ordering -----
type LodashCollectionOrdering = []|[{
  method?: ("sortBy" | "orderBy" | "orderByExplicit")
  useArray?: ("always" | "as-needed")
  [k: string]: unknown | undefined
}]
// ----- lodash/consistent-compose -----
type LodashConsistentCompose = []|[("pipe" | "compose" | "flow" | "flowRight")]
// ----- lodash/identity-shorthand -----
type LodashIdentityShorthand = []|[("always" | "never")]
// ----- lodash/import-scope -----
type LodashImportScope = []|[("method" | "member" | "full" | "method-package")]
// ----- lodash/matches-prop-shorthand -----
type LodashMatchesPropShorthand = []|[("always" | "never")]|[("always" | "never"), {
  onlyLiterals?: boolean
  [k: string]: unknown | undefined
}]
// ----- lodash/matches-shorthand -----
type LodashMatchesShorthand = []|[("always" | "never")]|[("always" | "never"), number]|[("always" | "never"), number, boolean]|[("always" | "never"), number, boolean, {
  onlyLiterals?: boolean
  [k: string]: unknown | undefined
}]
// ----- lodash/path-style -----
type LodashPathStyle = []|[("as-needed" | "array" | "string")]
// ----- lodash/prefer-constant -----
type LodashPreferConstant = []|[boolean]|[boolean, boolean]
// ----- lodash/prefer-filter -----
type LodashPreferFilter = []|[number]
// ----- lodash/prefer-get -----
type LodashPreferGet = []|[number]
// ----- lodash/prefer-includes -----
type LodashPreferIncludes = []|[{
  includeNative?: boolean
  [k: string]: unknown | undefined
}]
// ----- lodash/prefer-lodash-method -----
type LodashPreferLodashMethod = []|[{
  ignoredMethods?: string[]
  ignoredObjects?: string[]
  [k: string]: unknown | undefined
}]
// ----- lodash/prefer-matches -----
type LodashPreferMatches = []|[number]
// ----- lodash/prefer-reject -----
type LodashPreferReject = []|[number]
// ----- lodash/prefer-some -----
type LodashPreferSome = []|[{
  includeNative?: boolean
  [k: string]: unknown | undefined
}]
// ----- lodash/preferred-alias -----
type LodashPreferredAlias = []|[{
  ingoreMethods?: string[]
  [k: string]: unknown | undefined
}]
// ----- lodash/prop-shorthand -----
type LodashPropShorthand = []|[("always" | "never")]
...
type StyleMigrateMigrate = []|[{
  namespaceTo?: string
}]
// ----- style-migrate/migrate-js -----
type StyleMigrateMigrateJs = []|[{
  namespaceTo?: string
  namespaceFrom?: string
}]
// ----- style-migrate/migrate-jsx -----
type StyleMigrateMigrateJsx = []|[{
  namespaceTo?: string
  namespaceFrom?: string
}]
// ----- style-migrate/migrate-ts -----
type StyleMigrateMigrateTs = []|[{
  namespaceTo?: string
  namespaceFrom?: string
}]
...
export type ConfigNames = 'fino/command/rules' | 'fino/eslint-comments/rules' | 'fino/development' | 'fino/disables/scripts' | 'fino/disables/cli' | 'fino/disables/bin' | 'fino/disables/dts' | 'fino/disables/cjs' | 'fino/disables/config-files' | 'fino/emotion' | 'fino/formatter/setup' | 'fino/ignores' | 'fino/imports/rules' | 'fino/javascript/setup' | 'fino/javascript/rules' | 'fino/jsdoc/rules' | 'fino/jsonc/setup' | 'fino/jsonc/rules' | 'fino/jsx/setup' | 'fino/lodash/rules' | 'fino/markdown/setup' | 'fino/markdown/processor' | 'fino/markdown/parser' | 'fino/markdown/disables' | 'fino/migrate' | 'fino/node/rules' | 'fino/perfectionist/setup' | 'fino/pnpm/package-json' | 'fino/pnpm/pnpm-workspace-yaml' | 'fino/react/setup' | 'fino/react/rules' | 'fino/regexp/rules' | 'fino/stylistic/rules' | 'fino/tanstack/query/rules' | 'fino/test/setup' | 'fino/test/rules' | 'fino/toml/setup' | 'fino/toml/rules' | 'fino/typescript/setup' | 'antfu/typescript/parser' | 'fino/typescript/rules' | 'fino/unicorn/rules' | 'fino/unocss' | 'fino/yaml/setup' | 'fino/yaml/rules'
