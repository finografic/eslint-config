...
5. **GitHub Release appears**
   - View at: `https://github.com/finografic/eslint-config/releases`
...
1. **GitHub Release created**
   - `https://github.com/finografic/eslint-config/releases`

2. **Package published**
   - `https://github.com/finografic/eslint-config/packages`

3. **Workflow succeeded**
   - `https://github.com/finografic/eslint-config/actions`
